...
class ContentAgent:
    ...
    def _build_prompt(self, form: CampaignForm) -> str:
        return (
            ...
            "- O campo caption_bluesky deve ser uma versao escrita de raiz para publicar "
            "no Bluesky.\n"
            "- A caption_bluesky deve ter no maximo 300 caracteres no total, ja incluir "
            "um CTA e entre 1 e 3 hashtags e usar apenas frases completas.\n"
